...
import { GlobalSearch, SearchResult } from "../../components/global-search";
...
export const KeyboardShortCut: Story = {
  ...
  render: () => {
    ...
    return (
      <>
        <P>Press CTRL (or CMD on Mac) + K to open search</P>
        <Modal open={openState} title="Zoeken" size="m">
          <GlobalSearch
            placeholder="Zoek voor documenten, zaken, etc."
            search={async (query: string) => {
              await new Promise((resolve) => setTimeout(resolve, 500));
